...
void *G711DecThread(void *Argv)
{
    ...
    if (Type == DecG711A)
        Attr.enType = PTT_G711A;
    else if (Type == DecG711U)
        Attr.enType = PTT_G711U;
...
int main(int argc, char **argv)
{
    ...
    // strcpy(SrcFile, "/mnt/CODEC/test/Standard/TestFile/roomnumerr.mp3");
    // strcpy(DstFile, "/mnt/CODEC/test/Standard/TestFile/2.pcm");
    // DecType = DecMP3;
